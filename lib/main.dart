  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        error: Colors.redAccent.shade100, // Set the error color here
        ),
        fontFamily: 'GemunuLibre',
        appBarTheme: AppBarTheme(
              titleTextStyle: ThemeData.light().textTheme.headlineMedium?.copyWith(  // or headlineMedium
                      fontFamily: 'GemunuLibre',
                      fontSize: 30,
                    ),
        ...
        textTheme: const TextTheme(
          ...
          headlineMedium: TextStyle(fontSize: 30.0, fontWeight: FontWeight.normal),
          bodyLarge: TextStyle(fontSize: 25.0, fontWeight: FontWeight.w100),
          bodyMedium: TextStyle(fontSize: 25.0, fontWeight: FontWeight.w600),
        ),
      ),
